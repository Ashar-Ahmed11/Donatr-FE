...
const akhuwatLoanNetwork = () => {
  return (
   <>
          <Helmet>
                                                <meta charSet="utf-8" />
                                                <title>Akhuwat Loan Network</title>
                                                <meta name="description" content="Akhuwat Loan Network provides nationwide access to interest-free loans in Pakistan, connecting applicants with Akhuwat branches for transparent guidance, eligibility support, and a simple application process." />
                                            </Helmet>
...
export default akhuwatLoanNetwork
