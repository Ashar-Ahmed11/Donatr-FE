            ...
            <ul className="list-group pb-4">
                <li className="py-3 list-group-item">
                    <p className="h4 fw-normal">
                        For loans less than 5,00,000 the registration fee is Rs 7,700 which you need to pay first.
                    </p>
                </li>
                <li className="py-3 list-group-item">
                    <p className="h4 fw-normal">
                        For loans from 6,00,000 to 50,00,000 the registration fee is Rs 15,000 which you need to pay first.
                    </p>
                </li>
                <li className="py-3 list-group-item">
                    <p className="h4 fw-normal">
