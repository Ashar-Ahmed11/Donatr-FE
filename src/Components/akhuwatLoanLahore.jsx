...
const akhuwatLoanLahore = () => {
  return (
     <>
          <Helmet>
                                                <meta charSet="utf-8" />
                                                <title>Akhuwat Loan Lahore</title>
                                                <meta name="description" content="Akhuwat Loan Lahore provides interest-free financial support for education, business, and housing with simple eligibility and guidance from local Lahore branches." />
                                            </Helmet>
...
export default akhuwatLoanLahore
