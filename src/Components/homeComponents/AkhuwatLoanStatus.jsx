...
import asaanQarz22 from '../../Images/newAkhuwat9.jpg'
    ...
    <div className="container py-5" id='loan-status'>
      <div className="row align-items-center justify-content-center">
        ...
        <div className="col-md-6 p-5">
          ...
          <p>
            Entering your CNIC number is all it takes to see the progress of your Akhuwat Foundation loan application. It's also possible to get help or ask questions quickly by calling the Akhuwat Foundation Loan WhatsApp Helpline.
          </p>
        </div>
      </div>
