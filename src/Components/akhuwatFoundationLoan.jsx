...
const akhuwatFoundationLoan = () => {

  return (
     <>
         <Helmet>
                        <meta charSet="utf-8" />
                        <title>Akhuwat Foundation Loan</title>
                        <meta name="description" content="Akhuwat Foundation Loan provides interest-free financial support for education, business, and housing to help individuals and families achieve stability in Pakistan." />
                    </Helmet>
...
export default akhuwatFoundationLoan
