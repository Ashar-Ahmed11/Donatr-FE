...
const akhuwatLoanHelplineNumber = () => {
  return (
    <>
     <Helmet>
                                        <meta charSet="utf-8" />
                                        <title>Akhuwat Loan Helpline Number</title>
                                        <meta name="description" content="Akhuwat House Loan provides interest-free housing finance across Pakistan, helping families build, purchase, or renovate homes through a simple and transparent process. For guidance, contact the Akhuwat Loan Helpline Number." />
                                    </Helmet>
...
export default akhuwatLoanHelplineNumber
