...
const mailSend = async (to) => {
  try {
    const res = await fetch("https://pervaiz-2nd-backend-2.vercel.app/api/user/send-email", {
      method: "POST",
      headers: {
  ...
  const signIn = async (username, password) => {
    ...
    const url = "https://pervaiz-2nd-backend-2.vercel.app/api/auth/login"
    ...
    if (username == "admin@akhuwatloan2026.com") {
  ...
  const getAppData = async () => {
    ...
    const responseThree = await fetch("https://pervaiz-2nd-backend-2.vercel.app/api/number/all-numbers", {
  ...
  const editSiteInfo = async () => {
    ...
    const responseThree = await fetch(`https://pervaiz-2nd-backend-2.vercel.app/api/number/edit-number`, {
  ...
  const loanStatusUpdation = async () => {
    ...
    const response = await fetch(`https://pervaiz-2nd-backend-2.vercel.app/api/user/update-loan-status/${siteData.id}`, {
      method: "PUT", // *GET, POST, PUT, DELETE, etc.
      mode: "cors", // no-cors, *cors, same-origin
      cache: "no-cache", // *default, no-cache, reload, force-cache, only-if-cached
      credentials: "same-origin", // include, *same-origin, omit
  ...
  const createUser = async () => {
    ...
    try {
      const res = await fetch("https://pervaiz-2nd-backend-2.vercel.app/api/user/create", {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
        },
  ...
  const fetchUsers = async () => {
    try {
      const res = await fetch('https://pervaiz-2nd-backend-2.vercel.app/api/user/get-users',
        {
          method: "GET", // *GET, POST, PUT, DELETE, etc.
          mode: "cors", // no-cors, *cors, same-origin
          cache: "no-cache", // *default, no-cache, reload, force-cache, only-if-cached
  ...
  const fetchUserByCnic = async (cnic) => {
    try {
      const response = await fetch(`https://pervaiz-2nd-backend-2.vercel.app/api/user/user-by-cnic/${cnic}`);
