...
const akhuwatFoundationHelpline = () => {
  return (
   <>
         <Helmet>
                                    <meta charSet="utf-8" />
                                    <title>Akhuwat Foundation Helpline</title>
                                    <meta name="description" content="Akhuwat Foundation Helpline offers reliable assistance across Pakistan, providing complete guidance on interest-free loans, eligibility criteria, and the official application process through trusted Akhuwat channels." />
                                </Helmet>
...
export default akhuwatFoundationHelpline
