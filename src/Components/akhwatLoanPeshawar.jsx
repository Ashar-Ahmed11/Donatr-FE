...
const akhwatLoanPeshawar = () => {
  return (
    <>
          <Helmet>
                                                <meta charSet="utf-8" />
                                                <title>Akhwat Loan Peshawar</title>
                                                <meta name="description" content="Akhwat Loan Peshawar offers interest-free financial support for eligible individuals and families, with local branch assistance to ensure a simple, transparent, and trustworthy loan process." />
                                            </Helmet>
...
export default akhwatLoanPeshawar
