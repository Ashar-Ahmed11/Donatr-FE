...
const akhuwatLoanKarachi = () => {
  return (
    <>
      <Helmet>
                                            <meta charSet="utf-8" />
                                            <title>Akhuwat Loan Karachi</title>
                                            <meta name="description" content="Akhuwat Loan Karachi offers interest-free financial support for education, business, and housing with easy eligibility and local branch assistance in Karachi." />
                                        </Helmet>
...
export default akhuwatLoanKarachi
