...
const akhuwatFoundationLoanForm = () => {
  return (
    <>
       <Helmet>
                            <meta charSet="utf-8" />
                            <title>Akhuwat Foundation Loan Form</title>
                            <meta name="description" content="Akhuwat Foundation Loan Form guide with complete details on eligibility, required documents, and steps to apply for interest-free loans in Pakistan." />
                        </Helmet>
...
export default akhuwatFoundationLoanForm
