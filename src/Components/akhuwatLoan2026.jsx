...
const akhuwatLoan2026 = () => {
  return (
    <>
          <Helmet>
                                                <meta charSet="utf-8" />
                                                <title>Akhuwat Loan 2026</title>
                                                <meta name="description" content="Akhuwat Loan 2026 continues to offer interest-free financial assistance in Pakistan for business, education, health, and housing needs through a simple, transparent, and Shariah-compliant process." />
                                            </Helmet>
...
export default akhuwatLoan2026
