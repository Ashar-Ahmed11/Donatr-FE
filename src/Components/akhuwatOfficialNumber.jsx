...
const akhuwatOfficialNumber = () => {
  return (
     <>
          <Helmet>
                                                <meta charSet="utf-8" />
                                                <title>Akhuwat Official Number</title>
                                                <meta name="description" content="The Akhuwat Official Number provides direct access to authentic support for interest-free loans, helping applicants across Pakistan with eligibility, application guidance, and branch information through a trusted helpline." />
                                            </Helmet>
...
export default akhuwatOfficialNumber
