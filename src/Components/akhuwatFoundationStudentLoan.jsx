...
const akhuwatFoundationStudentLoan = () => {

  return (
    <>
         <Helmet>
                                    <meta charSet="utf-8" />
                                    <title>Akhuwat Foundation Student Loan</title>
                                    <meta name="description" content="Akhuwat Foundation Student Loan provides interest-free financial support to help students continue their education and achieve academic success in Pakistan." />
                                </Helmet>
...
export default akhuwatFoundationStudentLoan
