...
const akhuwatLoanOnlineApply = () => {
  return (
    <>
          <Helmet>
                                                <meta charSet="utf-8" />
                                                <title>Akhuwat Loan Online Apply</title>
                                                <meta name="description" content="Apply for Akhuwat Loan online easily! Access interest-free loans for education, business, and housing with a simple application process from anywhere in Pakistan." />
                                            </Helmet>
...
export default akhuwatLoanOnlineApply
