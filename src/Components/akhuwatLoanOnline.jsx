...
const akhuwatLoanOnline = () => {
  return (
    <>
     <Helmet>
                                <meta charSet="utf-8" />
                                <title>Akhuwat Loan Online</title>
                                <meta name="description" content="Akhuwat Loan Online helps applicants in Pakistan understand the interest-free loan process, eligibility requirements, and official application guidance while avoiding unauthorized agents or fake websites." />
                            </Helmet>
...
export default akhuwatLoanOnline
