...
const akhuwatLoanIslamabad = () => {
  return (
   <>
         <Helmet>
                                    <meta charSet="utf-8" />
                                    <title>Akhuwat Loan Islamabad</title>
                                    <meta name="description" content="Akhuwat Loan Islamabad provides interest-free financial assistance to eligible individuals and families, offering guidance through local Akhuwat branches for a transparent and reliable loan application process." />
                                </Helmet>
...
export default akhuwatLoanIslamabad
