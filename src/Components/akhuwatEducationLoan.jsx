...
const akhuwatEducationLoan = () => {
  return (
    <>
     <Helmet>
                <meta charSet="utf-8" />
                <title>Akhuwat Education Loan</title>
                <meta name="description" content="Akhuwat Education Loan helps students achieve their academic goals with interest-free financial support for college and higher education across Pakistan." />
            </Helmet>
...
export default akhuwatEducationLoan
